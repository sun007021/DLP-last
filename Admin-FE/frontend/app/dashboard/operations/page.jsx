...
export default function OperationsPage() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      default:
        return "bg-neutral-500/20 text-gray-300"
    }
  }
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-yellow-500 hover:bg-yellow-600 text-white">New Operation</Button>
          <Button className="bg-yellow-500 hover:bg-yellow-600 text-white">Mission Brief</Button>
        </div>
      </div>
          ...
          <Card className="bg-card border-border w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex gap-2 pt-4 border-t border-border">
                <Button className="bg-yellow-500 hover:bg-yellow-600 text-white">Update Status</Button>
                <Button
                  variant="outline"
                  className="border-border text-muted-foreground hover:bg-muted/50 hover:text-foreground bg-transparent"
                >
                  View Reports
                </Button>
                <Button
